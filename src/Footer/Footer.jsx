        ...
        <footer>
            <ul className="example-2">
                <li className="icon-content">
                    <a
                    href="https://open.spotify.com/user/31gagyfpmlv253v7nok5nqincl3a"
                    aria-label="Spotify"
                    data-social="spotify"
                    target="_blank"
                    >
                ...
                <li className="icon-content">
                    <a href="https://github.com/xtsebas" aria-label="GitHub" data-social="github" target="_blank">
                        <div className="filled"></div>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                ...
                <li className="icon-content">
                    <a
                    href="https://www.linkedin.com/in/sebasti%C3%A1n-huertas-53b749207/"
                    aria-label="LinkedIn"
